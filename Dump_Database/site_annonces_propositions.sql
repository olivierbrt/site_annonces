...
CREATE TABLE `propositions` (
  ...
  PRIMARY KEY (`id_prop`),
  KEY `fk_Propositions_id_user` (`id_user`),
  KEY `fk_Propositions_id_ann` (`id_ann`),
  CONSTRAINT `fk_Propositions_id_ann` FOREIGN KEY (`id_ann`) REFERENCES `annonces` (`id_ann`),
  CONSTRAINT `fk_Propositions_id_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`)
