...
router.get('/username/:username', auth(), awaitHandlerFactory(userController.getUserByuserName)); // localhost:3000/api/v1/users/usersname/oberthiau
router.get('/account', auth(), awaitHandlerFactory(userController.getCurrentUser)); // localhost:3000/api/v1/users/account
router.put('/account', auth(), updateUserSchema, awaitHandlerFactory(userController.updateCurrentUser)); // localhost:3000/api/v1/users/account
